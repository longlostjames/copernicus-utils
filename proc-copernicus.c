...
// 20210322 : CJW : revision of metadata                                                                                                
...
int main(int argc, char *argv[])
{
  ...
  add_text_global(ncid_out, "licence", "Data usage licence - UK Government Open Licence Agreement: http://www.nationalarchives.gov.uk/do\
c/open-government-licence");
  add_text_global(ncid_out, "acknowledgement", "Acknowledgement of NCAS as the data provider is required whenever and wherever these dat\
a are used");
